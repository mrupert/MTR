...
function tab_color() {
  echo -n -e "${bold}\033]6;1;bg;red;brightness;$1\a${normal}"
  echo -n -e "${bold}\033]6;1;bg;green;brightness;$2\a${normal}"
  echo -n -e "${bold}\033]6;1;bg;blue;brightness;$3\a${normal}"
}
